...
describe('obfuscate', () => {
  ...
  test('renders an unobfuscated child element right to left when obfuscated', () => {
    const wrapper = shallow(<Obfuscate obfuscate={true} tel={testTel} />)
  ...
  test('renders a custom element', () => {
    const wrapper = shallow(<Obfuscate element="span" viewOnly tel={testTel} />)
  ...
  test('Return empty href link if child is an object and no link is provided', () => {
    const wrapper = shallow(
      <Obfuscate>
        <button>This is a child object</button>
      </Obfuscate>
    )
...
test('renders an unobfuscated children when obfuscateChildren is false', () => {
  const wrapper = shallow(<Obfuscate obfuscateChildren={false} tel={testTel} />)
